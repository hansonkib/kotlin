...
class FirAccessResolveTransformer : FirAbstractTreeTransformerWithSuperTypes(reversedScopePriority = true) {
    ...
    private fun FirRegularClass.buildUseSiteScope(useSiteSession: FirSession = session): FirScope {
        return useSiteSession.service<FirScopeProvider>().getUseSiteMemberScope(this, useSiteSession)
    }
